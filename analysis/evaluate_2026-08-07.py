# -*- coding: utf-8 -*-
"""4週間（2026-07-13〜07-31）の全アラートを決済ルール別に検証する。

入力: output/alerts_2026-08-07.csv, bars_5m*.json（week1/2/3）
出力: output/eval_results_2026-08-07.json ＋ コンソール集計
実行: python -X utf8 evaluate_2026-08-07.py
...
alerts = list(csv.DictReader(open(os.path.join(OUT, "alerts_2026-08-07.csv"), encoding="utf-8")))

bars = defaultdict(list)
for fn in ("bars_5m.json", "bars_5m_week2.json", "bars_5m_week3.json", "bars_5m_week4.json"):
...
json.dump(res, open(os.path.join(OUT, "eval_results_2026-08-07.json"), "w"))
print("saved eval_results_2026-08-07.json")
